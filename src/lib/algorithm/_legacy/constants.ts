...
/** Trip duration to max backup days mapping (Legacy / Wizard-Slider-Obergrenzen) */
...
/** Höherer Erwartungswert bei „Ladebooster“ (Wizard), analog `AlgorithmSettings.alternatorEnhanced`. */
export const ENHANCED_ALTERNATOR_INPUT_AMPS = 90;
