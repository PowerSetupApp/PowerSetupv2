...
export default async function SchematicViewPage({ params }: SchematicViewPageProps) {
    ...
    if (!result || !result.schematicImageUrl) {
                ...
                <div className="container mx-auto max-w-7xl px-4 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <Button variant="outline" size="sm" asChild>
                            <a href={result.schematicImageUrl} target="_blank" rel="noopener noreferrer" download="schaltplan.jpg">
