...
export default function ResultDisplay({
    ...
    const selectedProducts = useMemo(() => {
        ...
        if (userConfig) {
            // 1. Shore Power -> Charger (use only 'charger', not 'ladegeraet')
