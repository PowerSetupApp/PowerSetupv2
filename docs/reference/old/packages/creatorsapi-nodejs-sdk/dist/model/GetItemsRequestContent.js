...
var _ItemIdType = _interopRequireDefault(require("./ItemIdType"));
  ...
  return _createClass(GetItemsRequestContent, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('additionalOffers')) {
          obj['additionalOffers'] = _ApiClient["default"].convertToType(data['additionalOffers'], 'Boolean');
        }
        ...
        if (data.hasOwnProperty('itemIdType')) {
          obj['itemIdType'] = _ItemIdType["default"].constructFromObject(data['itemIdType']);
        }
        ...
        if (data.hasOwnProperty('merchant')) {
          obj['merchant'] = _Merchant["default"].constructFromObject(data['merchant']);
        }
...
/**
 * Whether to retrieve additional offers outside the featured winners
 * @member {Boolean} additionalOffers
 */
GetItemsRequestContent.prototype['additionalOffers'] = undefined;
 ...
 */
GetItemsRequestContent.prototype['itemIdType'] = undefined;
 ...
 */
GetItemsRequestContent.prototype['merchant'] = undefined;
