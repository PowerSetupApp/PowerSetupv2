...
> **📖 Anleitung für KI:**  
> Vor dem Ausführen eines Tasks die unter **"Lies zuerst"** verlinkten PRD-Abschnitte öffnen und vollständig lesen!
>
> **Hinweis:** Die früher separaten Dateien `docs/PRD_00_…` bis `PRD_05_…` sind in **[PowerSetup_PRD.md](./PowerSetup_PRD.md)** zusammengeführt (Überschriften 1–18). Die Links unten springen in dieselbe Datei; thematische Zuordnung: Overview/User Flow/MVP → Abschnitte 1, 4, 16; UX/Wizard → 5; KI → 7; Schaltplan/PDF → 8; Credits/PayPal → 9; Persistenz/URLs → 10; Admin-Datenmodell → 11; Datenhaltung/DSGVO/Prisma-Bezug → 12; i18n → 13; Recht → 14; Tech Stack → 15.
> 
...
**Lies zuerst:**
- [PRD_05_Tech_Stack.md](./PowerSetup_PRD.md) – Tech Stack Übersicht, Ordnerstruktur
...
**Lies zuerst:**
- [PRD_02_Datenbank.md](./PowerSetup_PRD.md) – Prisma Schema, alle Models
- [PRD_05_Tech_Stack.md](./PowerSetup_PRD.md) – PostgreSQL Setup
...
**Lies zuerst:**
- [PRD_02_Datenbank.md](./PowerSetup_PRD.md) – Alle Zod-Schemas im Abschnitt "Produkt-Spezifikationen"
...
**Lies zuerst:**
- [PRD_01_UX_Formular.md](./PowerSetup_PRD.md) – UI-Komponenten Spezifikation
...
**Lies zuerst:**
- [PRD_01_UX_Formular.md](./PowerSetup_PRD.md) – Design-Prinzipien, Fortschrittsanzeige
- [PRD_05_Tech_Stack.md](./PowerSetup_PRD.md) – URL-Routing
...
**Lies zuerst:**
- [PRD_01_UX_Formular.md](./PowerSetup_PRD.md) – Schritt 1, 2, 3 Details
...
**Lies zuerst:**
- [PRD_01_UX_Formular.md](./PowerSetup_PRD.md) – Schritt 4: Verbraucher mit allen Kategorien
...
**Lies zuerst:**
- [PRD_01_UX_Formular.md](./PowerSetup_PRD.md) – Schritt 5 und 6
...
**Lies zuerst:**
- [PRD_01_UX_Formular.md](./PowerSetup_PRD.md) – Schritt 7, 8, optionale Zusatzfragen
...
**Lies zuerst:**
- [PRD_02_Datenbank.md](./PowerSetup_PRD.md) – Result Model, Daten-Lifecycle
- [PRD_05_Tech_Stack.md](./PowerSetup_PRD.md) – API Routes
...
**Lies zuerst:**
- [PRD_03_KI_Schaltplan.md](./PowerSetup_PRD.md) – Vorfilterung (Regelbasiert)
- [PRD_02_Datenbank.md](./PowerSetup_PRD.md) – Product Schema
...
**Lies zuerst:**
- [PRD_03_KI_Schaltplan.md](./PowerSetup_PRD.md) – KI-Prompt-Struktur, erwartete Antwort
- [PRD_05_Tech_Stack.md](./PowerSetup_PRD.md) – Gemini/OpenAI Code
...
**Lies zuerst:**
- [PRD_03_KI_Schaltplan.md](./PowerSetup_PRD.md) – PDF-Generierung, Inhalt
- [PRD_05_Tech_Stack.md](./PowerSetup_PRD.md) – Puppeteer Code
...
**Lies zuerst:**
- [PRD_01_UX_Formular.md](./PowerSetup_PRD.md) – Ergebnis-Seite (kostenlos)
- [PRD_00_Overview.md](./PowerSetup_PRD.md) – User Flow
...
**Lies zuerst:**
- [PRD_04_Credit_System.md](./PowerSetup_PRD.md) – PayPal-Integration, API-Endpunkte
- [PRD_05_Tech_Stack.md](./PowerSetup_PRD.md) – Umgebungsvariablen
...
**Lies zuerst:**
- [PRD_04_Credit_System.md](./PowerSetup_PRD.md) – Credit-Flow, Datenmodell, UI
...
**Lies zuerst:**
- [PRD_00_Overview.md](./PowerSetup_PRD.md) – MVP Scope
- [PRD_02_Datenbank.md](./PowerSetup_PRD.md) – Product, Category Models
...
**Lies zuerst:**
- [PRD_00_Overview.md](./PowerSetup_PRD.md) – Vision, Zielgruppe, User Flow
...
**Lies zuerst:**
- [PRD_00_Overview.md](./PowerSetup_PRD.md) – Internationalisierung
- [PRD_05_Tech_Stack.md](./PowerSetup_PRD.md) – i18n Libraries
...
**Lies zuerst:**
- [PRD_00_Overview.md](./PowerSetup_PRD.md) – Recht & Sicherheit
- [PRD_02_Datenbank.md](./PowerSetup_PRD.md) – DSGVO
...
**Lies zuerst:**
- [PRD_02_Datenbank.md](./PowerSetup_PRD.md) – Daten-Lifecycle, 90 Tage Löschung
...
**Lies zuerst:**
- [PRD_00_Overview.md](./PowerSetup_PRD.md) – Erfolgskriterien
...
| Datei | Inhalt | Link |
|-------|--------|------|
| Overview | Vision, Zielgruppe, User Flow, MVP Scope | [PRD_00_Overview.md](./PowerSetup_PRD.md) |
| UX & Formular | Multi-Step Formular, alle 8 Schritte, UI-Komponenten | [PRD_01_UX_Formular.md](./PowerSetup_PRD.md) |
| Datenbank | Prisma Schema, Zod-Validierung, DSGVO | [PRD_02_Datenbank.md](./PowerSetup_PRD.md) |
| KI & Schaltplan | Gemini/OpenAI, Prompts, PDF-Generierung | [PRD_03_KI_Schaltplan.md](./PowerSetup_PRD.md) |
| Credit-System | PayPal, Pakete, Credit-Flow | [PRD_04_Credit_System.md](./PowerSetup_PRD.md) |
| Tech Stack | Next.js, Vercel, Ordnerstruktur | [PRD_05_Tech_Stack.md](./PowerSetup_PRD.md) |
