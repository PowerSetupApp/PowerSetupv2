...
*   **Quellen (Mehrfachwahl):** [Solar](./wizard-algorithm-spec.md) (Spezifikation; Legacy-Logik u. a. in [`../src/lib/algorithm/adapter.ts`](../src/lib/algorithm/adapter.ts)), `Lichtmaschine` (Ladebooster), `Landstrom`
...
*   **Sonnenstunden (Peak Sun Hours):**
    *   `Sommer`: 5.0h
    *   `Ganzjahr/Mix`: 3.5h
    *   [Winter](../src/lib/store/wizard-store.ts): 2.0h
...
Der neue `requirements-engine.ts` (Spezifikation [wizard-algorithm-spec.md](./wizard-algorithm-spec.md), migrierte Legacy-Logik in [`adapter.ts`](../src/lib/algorithm/adapter.ts)) soll:
